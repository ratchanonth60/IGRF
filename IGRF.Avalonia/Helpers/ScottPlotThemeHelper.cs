...
namespace IGRF.Avalonia.Helpers
{
    ...
    public static class ScottPlotThemeHelper
    {
        ...
        /// </summary>
        public static ScottPlot.Plottables.Scatter CreateSatelliteMarker(
            Plot plot,
            double lon,
            double lat
        )
        ...
        )
        {
            ...
            var streamer = plot.Add.DataStreamer(
                Common.AppConstants.PlotSettings.DataStreamerCapacity
            );
